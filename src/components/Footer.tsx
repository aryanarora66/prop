      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              />
              <SocialIcon 
                href="mailto:contact@networty.com" 
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <FooterLink href="/ai-ideas" text="AI Ideas" />
          ...
          <div className="space-y-4">
            ...
            <form className="flex flex-col space-y-3">
              ...
              <button
                type="submit"
                className="px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-md hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 font-medium text-white shadow-md hover:shadow-lg"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Networty. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <FooterLink href="/privacy-policy" text="Privacy Policy" small />
            <FooterLink href="/terms-and-conditions" text="Terms and Conditions" small />
